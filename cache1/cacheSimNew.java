...
public class cacheSimNew {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        String curInst;
        try {
            BufferedReader reader = new BufferedReader(new FileReader("src/"+fname));
        ...
        bits = calcBits(blockSize,numBlocksL1,assocL1,instLength);
        blockOffsetBitsL1=bits[0];
        indexBitsL1=bits[1];
        taglengthL1=bits[2];
        bits=calcBits(blockSize,numBlocksL2,assocL2,instLength);
        ...
        while ((instructions.peek() != null)) {
            String[] instArr=instructions.remove().split(" ");
    ...
    public static int[] calcBits(int blockSize,int numBlocks,int assoc,int instLength)
    {
        int blockOffsetBits= (int)(Math.log(blockSize)/Math.log(2));
        int indexBits= (int)(Math.log(numBlocks/assoc)/Math.log(2));

        return new int[]{blockOffsetBits,indexBits,instLength-blockOffsetBits-indexBits};
    }
